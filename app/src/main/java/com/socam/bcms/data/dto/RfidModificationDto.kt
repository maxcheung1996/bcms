...
/**
 * DTO for RFID Module modification batch upload
 * Maps to the POST /Rfids/ModificationAppv2/Multi API
 */
data class RfidModificationDto(
    @SerializedName("Id")
    val id: String,
...
/**
 * API Response for batch modification
 */
data class BatchModificationResponse(
